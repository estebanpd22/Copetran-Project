...
public class AssignmentRepositoryTest extends AbstractRepositoryTI {
    ...
    void shouldFindByTripId() {
        ...
        Seat seat1 = createSeat(3, BigDecimal.valueOf(25000), SeatType.STANDARD, SeatStatus.AVAILABLE);
        Seat seat2 = createSeat(4, BigDecimal.valueOf(25000), SeatType.STANDARD, SeatStatus.AVAILABLE);
