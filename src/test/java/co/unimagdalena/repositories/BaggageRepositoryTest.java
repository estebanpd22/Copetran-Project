...
public class BaggageRepositoryTest extends AbstractRepositoryTI {
    ...
    void shouldFindByTicketId() {
        ...
        Seat seat1 = createSeat(15, BigDecimal.valueOf(50000), SeatType.STANDARD, SeatStatus.TAKEN);
    ...
    void shouldFindByTripId() {
        ...
        Seat seat1 = createSeat(10, BigDecimal.valueOf(80000), SeatType.PREFERENTIAL, SeatStatus.TAKEN);
        Seat seat2 = createSeat(20, BigDecimal.valueOf(60000), SeatType.STANDARD, SeatStatus.TAKEN);
    ...
    void shouldReturnEmptyListWhenNoBaggageForTicket() {
        ...
        Seat seat = createSeat(5, BigDecimal.valueOf(45000), SeatType.STANDARD, SeatStatus.TAKEN);
