...
public class SeatHoldRepositoryTest extends AbstractRepositoryTI {
    ...
    void shouldFindByTripId() {
        ...
        Seat seat1 = createSeat(bus, 1, BigDecimal.valueOf(50000), SeatType.STANDARD, SeatStatus.ON_HOLD);
        Seat seat2 = createSeat(bus, 2, BigDecimal.valueOf(60000), SeatType.PREFERENTIAL, SeatStatus.ON_HOLD);
    ...
    void shouldFindByUserId() {
        ...
        Seat seat = createSeat(bus, 3, BigDecimal.valueOf(55000), SeatType.STANDARD, SeatStatus.ON_HOLD);
    ...
    void shouldFindExpiredHolds() {
        ...
        Seat seat = createSeat(bus, 4, BigDecimal.valueOf(45000), SeatType.STANDARD, SeatStatus.ON_HOLD);
    ...
    void shouldReturnEmptyListWhenNoExpiredHolds() {
        ...
        Seat seat = createSeat(bus, 5, BigDecimal.valueOf(48000), SeatType.STANDARD, SeatStatus.ON_HOLD);
